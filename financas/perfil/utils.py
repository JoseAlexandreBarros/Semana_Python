...
def calcula_equilibrio_financeiro():
    ...
    total_gastos_essenciais = calculo_total(gastos_essenciais, 'valor')
    total_gastos_nao_essenciais = calculo_total(gastos_nao_essenciais, 'valor')
